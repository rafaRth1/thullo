...
import { initialStateListSlice } from './initialstate-list-slice';
...
export const listSlice = createSlice({
	...
	reducers: {
		...
		startGetProjectAndLists: (state: InitialStateListSlice, action: FulfilledAction<{ project: any; lists: any }>) => {
			state.loading = false;
		...
		editTaskCard: (state: InitialStateListSlice, action: FulfilledAction<{ data: any; listId?: string }>) => {

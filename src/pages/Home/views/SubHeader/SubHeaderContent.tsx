...
import { ImageProfile, FormCollabrator, Button, Spinner } from '@components/';
...
export const SubHeaderContent = memo(
	({ project, setIsShowMenuProject, isShowMenuProject, isLoadingProject }: Props) => {
